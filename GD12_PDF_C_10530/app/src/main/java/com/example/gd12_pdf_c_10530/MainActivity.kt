package com.example.gd12_pdf_c_10530
...
import com.example.gd12_pdf_c_10530.databinding.ActivityMainBinding
...
class MainActivity : AppCompatActivity() {
    ...
    private fun createPdf(nama: String, umur: String, tlp: String, alamat: String, kampus: String) {
        ...
        val file = File(pdfPath, "pdf_10530.pdf")
        ...
        @SuppressLint("UseCompactLoadingForDrawables") val d = getDrawable(R.drawable.coffe)
